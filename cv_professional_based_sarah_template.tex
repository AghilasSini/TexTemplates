...
\setmarginsrb{2.2cm}{0.1cm}{2.2cm}{2.2cm}{0.96cm}{0.96cm}{0.96cm}{0.96cm}
...
\\
\begin{rubrique}[0.4cm]{\,\underline{\small{Principaux domaines d'intervantion}}}
&\bull Maintenance évolutive d'outils d'analyse et traitement de signal de parole (JSnoori), d'alignment parole texte (JTrans), d'analyse simantique-syntaxique (J\--Safran),\\
&\bull Re\--factoring du code, de l'architecture.\\
	&\bull  Dévellopement de Portail web pour les outils.\\
	&\bull  Ecriture de test unitaire.\\
	&\bull  Ecriture de test de covering.\\
	&\bull  Ecriture de test d'integration continue.\\
\end{rubrique}
\interRubrique
\\
\begin{rubrique}[0.4cm]{\,\underline{\small{Environnement Technique}}}
& \bull Shell Script, Jython, Java, Linux.\\
& \bull Jenkins (INRIA platform), Clover.\\  
...
\interRubrique
\\
  \begin{rubrique}[21cm]{\Large{ Mars 2014 -Août 2014  }}
