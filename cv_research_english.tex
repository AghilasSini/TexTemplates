...
Mar 2016	 &\lieu{IUT Charlemagne,Lorraine University Nancy.}\\
...
Jan 2016 &\activite{IFCASL Project Individualized Feedback for Computer-Assisted Spoken Language 
  Learning} \\ 
		 ...
		 &\-- Modification and resythesis of learner audio samples using teacher audio samples based on Pitch Synchronous Overlap And Add Algorithm\\
		&\-- Feedback to
correct devoicing of final consonants in French  spoken by German learner.\\
		&\-- improving speech texte alignemt for language learning using deep neural network, training network with theano and decoding with DN4J (IFCASL Corpus).\\ 		
		&\-- speech features extraction for pitch detection using deep neural network.\\ 
		\\
Nov 2014 
 &\activite{ORTOLANG Project Open Resources and TOols for LANGuage}\\ 			Jan 2016&\lieu{LORIA Laboratory Nancy.}\\
	&\-- Developement of syntactic-semantic analyser for spoken documents in  French language \-- open source tool J\--Safran released by LORIA. Includes dependency parser for oral speech and inclusion of inference of partial semantic role labels on top of syntactic parsing.\\
	&\-- Tool for semi\--automatic alignement of speech and textual corpus \-- open source tool JTRANS relesead by LORIA. Working on correction of speech and text alignement around silence segments.\\
	&\-- Interactive tool for speech signal processing and phonetics \-- open source tool JSnoori released by LORIA. Developement of module for pitch estimation.
\end{rubrique}
   \interRubrique
   \\
   \begin{rubrique}[2.0cm]{\textit{ Intership}}\\
 Mar 2014 
...
\\
   \begin{rubrique}[3.4cm]{\textit{ Other Activities}}\\
	  & \-- Data collection for IFCASL Project \\
   	 &\-- Member of Deep Learning Group at LORIA\\
...
\\
 \begin{rubrique}[3.4cm]{\textit{ Online Certificate Courses}}\\
  ...
  present  & \lieu{Johns-Hopkins University} \comment{\textbf{by Jeff Leek, PhD, Roger D. Peng, PhD \& Brian Caffo, PhD}}\\ \\
    %%%%%%
      Dec 2015
