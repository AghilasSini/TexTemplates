 ...
 Jan 2016 present &\activite{IFCASL Project (Individualized Feedback for Computer-Assisted Spoken Language 
  Learning)} \\ 
	 &\lieu{LORIA\--INRIA Laboratory Nancy.}\\
		&\--  Automatic pronounciation diagnosis and error detection for germans learning french\\	
...
\\
(2) Ghosh, S., Sini, A., Laprie, Y. \& Camille Fauth, C. 2016. L1-L2 interference: the case of final devoicing of French voiced fricatives in final position by German learners. To appear in Proceedings of Interspeech 2016, San Francisco. \\
\end{rubrique}
 \interRubrique
