...
\begin{rubrique}[21cm]{\underline{Research Interest}}\\
...
\interRubrique
 ...
 \interRubrique
 \\
	\begin{rubrique}[2cm]{\textit{Summer School attended}}\\
   Jul &\activite{Speech Synthesis Summer School }\\   
...
\begin{rubrique}[3.4cm]{\underline{Professional Experience}}
\end{rubrique} 

\begin{rubrique}[2.0cm]{\textit{As an engineer}}
\interRubrique
 \\
 &\activite{IFCASL Project (Individualized Feedback for Computer-Assisted Spoken Language 
  Learning)} \\ 

Jan 2016		 &\lieu{LORIA\--INRIA Laboratory Nancy.}\\
present		&\--  Automatic pronounciation diagnosis and error detection for germans learning french\\	
		 &\-- Modification and re-synthesis  of learner audio samples using teacher audio samples based on Pitch Synchronous Overlap and Add algorithm\label{CALL}\\
...
\end{rubrique}
 ...
 Mar 2014 
   & \activite{Mapping of a sound environment for a mobile robot\label{robotic}}\\
...
\interRubrique
\\
\begin{rubrique}[16cm]{\underline{Publications}}
\\
 
(1\ref{robotic}) E. Vincent, A. Sini and F. Charpillet, ``Audio source localization by optimal control of a mobile robot,`` Acoustics, Speech and Signal Processing (ICASSP), 2015 IEEE International Conference on, South Brisbane, QLD, 2015, pp. 5630-5634.\\
\\
(2\ref{CALL}) Ghosh, S., Sini, A., Laprie, Y. \& Camille Fauth, C. 2016. L1-L2 interference: the case of final devoicing of French voiced fricatives in final position by German learners. To appear in Proceedings of Interspeech 2016, San Francisco. \\
\end{rubrique}
 \interRubrique
 \\
\begin{rubrique}[3.4cm]{\underline{Activities \& Independent Courses}}\\   
\end{rubrique} 
\\
\begin{rubrique}[2.0cm]{\textit{ Other Activities}}\\
...
\interRubrique
\\
 \begin{rubrique}[2.0cm]{\textit{ Online Certificate Courses}}\\
   Oct 2015 
 ...
 \end{rubrique}
	\interRubrique
	\\
	\begin{rubrique}[3.4cm]{\underline{Computer Skills}}
\\	
...
\begin{rubrique}[21cm]{\underline{Communication Skills}}
\\
	\textbf{French} \, (fluent)\,  
    \textbf{English}\, (fluent), \textbf{German} \, (beginner)
    
\end{rubrique}
\interRubrique
\\

\begin{rubrique}[3.4cm]{\underline{References}}
\\
