...
\interRubrique
 ...
 \\ \\
   Jul &\activite{Speech Synthesis: Advancement in Modern Speech Synthesis Engines}\\   
...
\\
(2) S. Ghosh, A. Sini, Y. Laprie and C. Fauth, ``L1-L2 interference: the case of final devoicing of French voiced fricatives in final position by German learners``. To appear in Proceedings of Interspeech 2016, San Francisco. \\
\end{rubrique}
 \interRubrique
